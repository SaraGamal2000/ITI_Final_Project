    ...
    const featuredchef = [
        {
            id: 1,
            title: "chef1",
            description: "Description of chef 1",
            img: img1bg,
        },
        {
            id: 2,
            title: "chef 2",
            description: "Description of chef 2",
            img: img2bg,
        },
        {
            id: 3,
            title: "chef 3",
            description: "Description of chef 3",
            img: img1bg,
        },
        {
            id: 4,
            title: "chef4",
            description: "Description of chef 4",
            img: img1bg,
        },
    ];
                    ...
                    >
                        <Col md={6} className="text-center text-warning m-5">
                            <h1 className="text-warning  m-4">
                                Explore <span className="m-1"> Home </span>{" "}
                                Cooked <span className="m-1 ">Food</span> &
                                Sweets
                            </h1>
                            <p
                                style={{
                            ...
                            >
                                Discover the best homemade dishes in your city
                            </p>
                            <Button
                                variant="warning"
                                className="bg-orange m-5 w-75 fs-3"
                                href="#search-section"
                            >
                                Start Your Search
                            </Button>
                ...
                <Container>
                    ...
                    <Row className="justify-content-center">
                        <Col className="d-flex">
                            ...
                            <Button
                                variant=" bg-orange"
                                className="search-button btn btn-outline-warning rounded-4 "
                            >
                    ...
                    {/* {featuredchef.map((chef) => (
                        <Col md={3} key={chef.id} className="mb-4">
                            <Card className="m-3 shadow bg-light">
                                ...
                                />
                                <Card.Body>
                                    <Card.Title className="text-dark fs-4">
                                        {chef.title}
                                    </Card.Title>
                                    ...
                                    <div className="mt-auto">
                                        <Button
                                            ...
                                            className="rounded-5 m-1 w-100  text-dark fs-6"
                                            href={`/chefs/${chef.id}`}
                                        >
                                            View Details
                                        </Button>
